...
public class ReadGZippedTAQQuotesFile {
	...
	public static void example1() {
		String f = "C:\\Users\\Zhenghong Dong\\SkyDrive\\dappled's sky\\cs\\eclipse\\CIF\\src\\dBReader\\sampleTAQ\\quotes\\20070620\\IBM_quotes.binRQ";
		try {
			...
			// Iterate over all records, writing the contents of each to the console
				System.out.println(taqQuotes.getSecsFromEpoch());
				System.out.println(taqQuotes.getNRecs());
				int nRecs = taqQuotes.getNRecs();
				for( int i = nRecs-20; i < nRecs; i++ ) {
					System.out.println(
